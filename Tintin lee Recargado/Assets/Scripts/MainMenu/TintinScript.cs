    ...
    void Update()
    {
        ...
        switch (_count)
        {
            ...
            case 190:
                ...
                _redB.transform.position = new Vector2(-0.44f, 0.73f);
                _fluoB.transform.position = new Vector2(-0.55f, 0.76f);
                _purpleB.transform.position = new Vector2(0.45359f, 0.7f);
                break;
            case 195:
                _greenB.transform.position = new Vector3(-0.652f, 0.947f);
                _blueB.transform.position = new Vector3(-0.3144f, 0.78f);
                break;
            case 200:
                _greenB.transform.position = new Vector3(-0.848f, 1.0155f);
                _blueB.transform.position = new Vector3(-0.2466f, 0.78f);
                break;
            case 205:
                _greenB.transform.position = new Vector3(-1.004f, 1.084f);
                _blueB.transform.position = new Vector3(-0.1788f, 0.78f);
                break;
            case 210:
                _greenB.transform.position = new Vector3(-1.24f, 1.1525f);
                _blueB.transform.position = new Vector3(-0.111f, 0.78f);
                break;
            case 215:
                _greenB.transform.position = new Vector3(-1.436f, 1.221f);
                _blueB.transform.position = new Vector3(-0.0432f, 0.78f);
                break;
            case 220:
                _greenB.transform.position = new Vector3(-1.632f, 1.2895f);
                _blueB.transform.position = new Vector3(0.0246f, 0.78f);
                break;
            case 225:
                _greenB.transform.position = new Vector3(-1.828f, 1.358f);
                _blueB.transform.position = new Vector3(0.0924f, 0.78f);
                break;
            case 230:
                _greenB.transform.position = new Vector3(-2.024f, 1.4265f);
                _blueB.transform.position = new Vector3(0.1602f, 0.78f);
                break;
            case 235:
                _greenB.transform.position = new Vector3(-2.22f, 1.495f);
                _blueB.transform.position = new Vector3(0.228f, 0.78f);
                break;
            case 240:
                _greenB.transform.position = new Vector3(-2.416f, 1.5635f);
                _blueB.transform.position = new Vector3(0.2958f, 0.78f);
                break;
            case 245:
                _greenB.transform.position = new Vector3(-2.612f, 1.632f);
                _blueB.transform.position = new Vector3(0.3636f, 0.78f);
                break;
            case 250:
                _greenB.transform.position = new Vector3(-2.808f, 1.7005f);
                _blueB.transform.position = new Vector3(0.4314f, 0.78f);
                break;
            case 255:
                _greenB.transform.position = new Vector3(-3.004f, 1.769f);
                _blueB.transform.position = new Vector3(0.4992f, 0.78f);
                break;
